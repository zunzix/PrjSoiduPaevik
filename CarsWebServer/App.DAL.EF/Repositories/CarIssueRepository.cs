...
{
    public CarIssueRepository(AppDbContext repositoryDbContext) : base(repositoryDbContext)
    {
    }
    ...
    public async Task<IEnumerable<CarIssue>> AllCarCarIssuesAsync(IEnumerable<CarIssue> userCarIssues, Guid carId)
    {
